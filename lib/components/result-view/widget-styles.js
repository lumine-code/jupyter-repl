...
// hard-coded light theme. styles/jupyter-repl.css supplies those names from the
...
// block in styles/jupyter-repl.css declares the --jp-* names on.
...
function ensureWidgetStyles() {
  ...
  disposable = lumine.styles.addStyleSheet(source, {
    ...
    // Before the package's own sheet, so styles/jupyter-repl.css wins at equal
