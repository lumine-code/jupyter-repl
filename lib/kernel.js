...
class Kernel {
  ...
  execute(code, onResults) {
    ...
    this.firstMiddlewareAdapter.execute(code, (message, channel) => {
      ...
      // find the entry's duration already frozen.
      ...
      if (msg_type === "execute_input") {
        ...
        this.transport.setExecutionStartTime(entry.startedAt);
      ...
      if (msg_type === "execute_reply") {
        ...
        entry.settled = true;
        this.setLastExecutionTime(formatElapsedTime(entry.durationMs));
      }
