  ...
  store.subscriptions.add(
    ...
    lumine.commands.add("lumine-workspace", {
      ...
      "jupyter-repl:run-all": {
        ...
        didDispatch: (event) => runAll(null, event),
      },
      "jupyter-repl:run-all-above": {
        description: "Run every cell above the cursor.",
        didDispatch: (event) => runAllAbove(event),
      },
      ...
      "jupyter-repl:export-notebook": {
        description: "Write this file out as an ipynb notebook.",
        didDispatch: () => require("./export-notebook").exportNotebook(),
      },
      "jupyter-repl:fold-current-cell": {
        description: "Fold the cell holding the cursor.",
        didDispatch: () => foldCurrentCell(),
      },
      "jupyter-repl:fold-all-but-current-cell": {
        description: "Fold every cell except the one holding the cursor.",
        didDispatch: () => foldAllButCurrentCell(),
      },
      ...
      "jupyter-repl:clear-and-center": {
        description: "Remove the results and scroll the cursor to the middle.",
        didDispatch: () => clearAndCenter(),
      },
      "jupyter-repl:recalculate-all": {
        description: "Restart the kernel, clear the results, and run everything.",
        didDispatch: () => recalculateAll(),
      },
      "jupyter-repl:recalculate-all-above": {
        description: "Restart the kernel and run everything above the cursor.",
        didDispatch: () => recalculateAllAbove(),
      },
      ...
      "jupyter-repl:go-to-next-cell": {
        description: "Move the cursor to the start of the next cell.",
        didDispatch: () => require("./cell-navi").nextCell(),
      },
      "jupyter-repl:go-to-previous-cell": {
        description: "Move the cursor to the start of the previous cell.",
        didDispatch: () => require("./cell-navi").previousCell(),
      },
      "jupyter-repl:select-cell": {
        description: "Select the whole of the cell holding the cursor.",
        didDispatch: () => require("./cell-navi").selectCell(),
      },
      "jupyter-repl:select-previous-cell": {
        description: "Extend the selection to take in the previous cell.",
        didDispatch: () => require("./cell-navi").selectUp(),
      },
      "jupyter-repl:select-next-cell": {
        description: "Extend the selection to take in the next cell.",
        didDispatch: () => require("./cell-navi").selectDown(),
      },
      "jupyter-repl:move-cell-up": {
        description: "Swap this cell with the one above it.",
        didDispatch: () => require("./cell-navi").moveCellUp(),
      },
      "jupyter-repl:move-cell-down": {
        description: "Swap this cell with the one below it.",
        didDispatch: () => require("./cell-navi").moveCellDown(),
      },
