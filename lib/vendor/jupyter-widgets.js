...
// Built from:
//   @jupyter-widgets/base@6.0.12
//   @jupyter-widgets/base-manager@1.0.13
//   @jupyter-widgets/controls@5.0.13
...
var require_package = __commonJS({
  "node_modules/@jupyter-widgets/controls/package.json"(exports, module2) {
    module2.exports = {
      ...
      gitHead: "af2386d4b0cb4f5b60581de09a47e5a54d0cd356"
    };
  }
});
...
__export(index_es6_exports, {
  ...
  ScrollBar: () => ScrollBar,
  SingletonLayout: () => SingletonLayout,
...
var ContextMenu = class {
  ...
  addItem(options) {
    ...
    this._items.push(item);
    return new import_disposable3.DisposableDelegate(() => {
      import_algorithm2.ArrayExt.removeFirstOf(this._items, item);
    });
  }
  /**
...
var FocusTracker = class {
  constructor() {
    ...
    this._activeChanged = new import_signaling2.Signal(this);
    this._currentChanged = new import_signaling2.Signal(this);
  }
  /**
  ...
  remove(widget) {
    ...
    widget.node.removeEventListener("focus", this, true);
    widget.node.removeEventListener("blur", this, true);
    import_algorithm2.ArrayExt.removeFirstOf(this._widgets, widget);
    ...
    let previous = (0, import_algorithm2.max)(valid, (first, second) => {
  ...
  _evtBlur(event) {
    ...
    if (!(0, import_algorithm2.find)(this._widgets, (w) => w.node.contains(focusTarget))) {
      this._setWidgets(this._currentWidget, null);
      return;
    }
  }
...
var ScrollBar = class extends Widget {
  ...
  constructor(options = {}) {
    ...
    this._onRepeat = () => {
      ...
      if (part === "decrement") {
        if (!import_domutils2.ElementExt.hitTest(this.decrementNode, mouseX, mouseY)) {
          return;
        }
      ...
      if (part === "increment") {
        if (!import_domutils2.ElementExt.hitTest(this.incrementNode, mouseX, mouseY)) {
          return;
        }
      ...
      if (part === "track") {
        if (!import_domutils2.ElementExt.hitTest(this.trackNode, mouseX, mouseY)) {
          return;
        }
        let thumbNode = this.thumbNode;
        if (import_domutils2.ElementExt.hitTest(thumbNode, mouseX, mouseY)) {
          return;
        }
    ...
    this._repeatTimer = -1;
    this._pressData = null;
    this._thumbMoved = new import_signaling2.Signal(this);
    this._stepRequested = new import_signaling2.Signal(this);
    this._pageRequested = new import_signaling2.Signal(this);
...
var SingletonLayout = class extends Layout {
  constructor() {
    super(...arguments);
    this._widget = null;
  }
...
var StackedPanel = class extends Panel {
  /**
  ...
  constructor(options = {}) {
    ...
    this._widgetRemoved = new import_signaling2.Signal(this);
...
var TabPanel = class extends Widget {
  ...
  constructor(options = {}) {
    ...
    let direction = Private4.directionFromPlacement(this._tabPlacement);
    let orientation = Private4.orientationFromPlacement(this._tabPlacement);
  ...
  set tabPlacement(value) {
    ...
    let direction = Private4.directionFromPlacement(value);
    let orientation = Private4.orientationFromPlacement(value);
    this.tabBar.orientation = orientation;
...
var TabPanel2 = class extends Widget {
  /**
   * Construct a new tab panel.
   *
   * @param options - The options for initializing the tab panel.
...
var JupyterLuminoTabPanelWidget = class extends TabPanel2 {
  constructor(options) {
    const view = options.view;
    delete options.view;
    super(options);
