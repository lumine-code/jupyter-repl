...
function outputServiceForDocument() {
  // Renderer functions are data-only factories. Their stateful components
  // resolve Plotly, Vega and widget runtimes from their mounted element's
  // ownerDocument, so the service itself is deliberately shared.
...
const outputService = Object.freeze({
  ...
  pickRenderers,
  isTextOutputOnly,
  forDocument: outputServiceForDocument,
